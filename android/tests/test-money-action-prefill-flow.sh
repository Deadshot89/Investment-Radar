...
# bis in die manuelle Kauf-/Verkaufsmaske mitnehmen.
...
grep -Fq 'pendingActionAmountEur = action.amountEur' "$UI" || fail 'Aktionsbetrag wird beim Öffnen der Transaktionsmaske nicht übernommen.'
