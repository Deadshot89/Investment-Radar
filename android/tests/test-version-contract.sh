...
# Final Integration Contract für Investment Radar 2.5.18 / Android 2.5.18.
...
grep -Fq 'versionCode = 88' "$GRADLE_FILE" || fail 'Android versionCode muss 88 sein.'
grep -Fq 'versionName = "2.5.18"' "$GRADLE_FILE" || fail 'Android versionName muss 2.5.18 sein.'
grep -Fq 'Release candidate: Investment Radar 2.5.18' "$GRADLE_FILE" || fail 'Release-Kandidat muss 2.5.18 benennen.'
...
echo 'PASS: Android 2.5.18/code88 mit Backend-Vertrag 2.1.0 und bereinigtem Release-Branch.'
