...
# Final Integration Contract für Investment Radar 2.5.13 / Android 2.5.13.
...
grep -Fq 'versionCode = 83' "$GRADLE_FILE" || fail 'Android versionCode muss 81 sein.'
grep -Fq 'versionName = "2.5.13"' "$GRADLE_FILE" || fail 'Android versionName muss 2.5.13 sein.'
grep -Fq 'Release candidate: Investment Radar 2.5.13' "$GRADLE_FILE" || fail 'Release-Kandidat muss 2.5.13 benennen.'
...
echo 'PASS: Android 2.5.13/code83 mit Backend-Vertrag 2.1.0 und bereinigtem Release-Branch.'
