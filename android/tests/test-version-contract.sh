...
# Final Integration Contract für Investment Radar 2.5.16 / Android 2.5.16.
...
grep -Fq 'versionCode = 86' "$GRADLE_FILE" || fail 'Android versionCode muss 86 sein.'
grep -Fq 'versionName = "2.5.16"' "$GRADLE_FILE" || fail 'Android versionName muss 2.5.16 sein.'
grep -Fq 'Release candidate: Investment Radar 2.5.16' "$GRADLE_FILE" || fail 'Release-Kandidat muss 2.5.16 benennen.'
...
echo 'PASS: Android 2.5.16/code86 mit Backend-Vertrag 2.1.0 und bereinigtem Release-Branch.'
