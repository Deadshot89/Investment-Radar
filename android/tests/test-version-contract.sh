...
# Final Integration Contract für Investment Radar 2.5.14 / Android 2.5.14.
...
grep -Fq 'versionCode = 84' "$GRADLE_FILE" || fail 'Android versionCode muss 84 sein.'
grep -Fq 'versionName = "2.5.14"' "$GRADLE_FILE" || fail 'Android versionName muss 2.5.14 sein.'
grep -Fq 'Release candidate: Investment Radar 2.5.14' "$GRADLE_FILE" || fail 'Release-Kandidat muss 2.5.14 benennen.'
...
echo 'PASS: Android 2.5.14/code84 mit Backend-Vertrag 2.1.0 und bereinigtem Release-Branch.'
