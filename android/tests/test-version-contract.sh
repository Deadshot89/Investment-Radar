...
# Final Integration Contract für Investment Radar 2.5.5 / Android 2.5.5.
...
grep -Fq 'versionCode = 75' "$GRADLE_FILE" || fail 'Android versionCode muss 75 sein.'
grep -Fq 'versionName = "2.5.5"' "$GRADLE_FILE" || fail 'Android versionName muss 2.5.5 sein.'
grep -Fq 'Release candidate: Investment Radar 2.5.5' "$GRADLE_FILE" || fail 'Release-Kandidat muss 2.5.5 benennen.'
...
echo 'PASS: Android 2.5.5/code75 mit Backend-Vertrag 2.1.0 und bereinigtem Release-Branch.'
