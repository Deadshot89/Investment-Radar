...
# Final Integration Contract für Investment Radar 2.5.17 / Android 2.5.17.
...
grep -Fq 'versionCode = 87' "$GRADLE_FILE" || fail 'Android versionCode muss 87 sein.'
grep -Fq 'versionName = "2.5.17"' "$GRADLE_FILE" || fail 'Android versionName muss 2.5.17 sein.'
grep -Fq 'Release candidate: Investment Radar 2.5.17' "$GRADLE_FILE" || fail 'Release-Kandidat muss 2.5.17 benennen.'
...
echo 'PASS: Android 2.5.17/code87 mit Backend-Vertrag 2.1.0 und bereinigtem Release-Branch.'
