...
# Final Integration Contract für Investment Radar 2.5.19 / Android 2.5.19.
...
grep -Fq 'versionCode = 89' "$GRADLE_FILE" || fail 'Android versionCode muss 88 sein.'
grep -Fq 'versionName = "2.5.19"' "$GRADLE_FILE" || fail 'Android versionName muss 2.5.18 sein.'
grep -Fq 'Release candidate: Investment Radar 2.5.19' "$GRADLE_FILE" || fail 'Release-Kandidat muss 2.5.19 benennen.'
...
echo 'PASS: Android 2.5.19/code89 mit Backend-Vertrag 2.1.0 und bereinigtem Release-Branch.'
