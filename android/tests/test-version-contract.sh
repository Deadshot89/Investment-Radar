...
# Final Integration Contract für Investment Radar 2.5.22 / Android 2.5.22.
...
grep -Fq 'versionCode = 92' "$GRADLE_FILE" || fail 'Android versionCode muss 91 sein.'
grep -Fq 'versionName = "2.5.22"' "$GRADLE_FILE" || fail 'Android versionName muss 2.5.22 sein.'
grep -Fq 'Release candidate: Investment Radar 2.5.22' "$GRADLE_FILE" || fail 'Release-Kandidat muss 2.5.22 benennen.'
...
echo 'PASS: Android 2.5.22/code92 mit Backend-Vertrag 2.1.0 und bereinigtem Release-Branch.'
