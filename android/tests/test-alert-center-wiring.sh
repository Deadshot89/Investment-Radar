...
grep -Fq 'else -> missingAlertItemMessage = "Das Wertpapier ist nicht im aktuellen Radar enthalten."' "$MAIN"
grep -Fq 'Wertpapier nicht im Radar' "$MAIN"
! grep -Fiq 'Wertpapier nicht verfügbar' "$MAIN"
