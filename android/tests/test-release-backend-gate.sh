...
grep -q 'versionCode = 50' "$GRADLE"
grep -q 'versionName = "2.0.4"' "$GRADLE"
grep -q 'Investment Radar 2.0.4' "$GRADLE"
...
echo "PASS Android app release is monotonic at 2.0.4 / code 50"
