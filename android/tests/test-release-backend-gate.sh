...
grep -q 'versionCode = 47' "$GRADLE"
grep -q 'versionName = "2.0.1"' "$GRADLE"
grep -q 'Investment Radar 2.0.1' "$GRADLE"
...
echo "PASS Android app release is monotonic at 2.0.1 / code 47"
