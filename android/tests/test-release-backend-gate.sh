...
# The backend contract remains 2.1.0; Android 2.1.5/code58 advances independently.
grep -q 'versionCode = 58' "$GRADLE"
grep -q 'versionName = "2.1.5"' "$GRADLE"
grep -q 'Investment Radar 2.1.5' "$GRADLE"
...
echo "PASS Android app release is monotonic at 2.1.5 / code 58"
