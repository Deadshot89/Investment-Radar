...
grep -q 'versionCode = 51' "$GRADLE"
grep -q 'versionName = "2.0.5"' "$GRADLE"
grep -q 'Investment Radar 2.0.5' "$GRADLE"
...
echo "PASS Android app release is monotonic at 2.0.5 / code 51"
