...
import { selectBuyFilterResults } from "../src/lib/radar.mjs";

test("BUY filter falls back to at most three strong verified WATCH candidates", () => {
  const analyzed = [
    { id: "blocked", recommendation: "NO_BUY", purchaseEligible: false, scoreTotal: 95, coverage: 100, risk: 1, tradeRepublicEligible: true, name: "Blocked" },
    { id: "best", recommendation: "WATCH", purchaseEligible: false, scoreTotal: 84, coverage: 90, risk: 2, tradeRepublicEligible: true, name: "Best" },
    { id: "second", recommendation: "WATCH", purchaseEligible: false, scoreTotal: 79, coverage: 80, risk: 3, tradeRepublicEligible: true, name: "Second" },
    { id: "third", recommendation: "WATCH", purchaseEligible: false, scoreTotal: 76, coverage: 75, risk: 2, tradeRepublicEligible: true, name: "Third" },
    { id: "weak", recommendation: "WATCH", purchaseEligible: false, scoreTotal: 61, coverage: 90, risk: 1, tradeRepublicEligible: true, name: "Weak" },
    { id: "unverified", recommendation: "WATCH", purchaseEligible: false, scoreTotal: 99, coverage: 99, risk: 1, tradeRepublicEligible: null, name: "Unverified" }
  ];
